...
git tag --annotate v0.1.2 --message "Sponsor Shell v0.1.2"
...
```sh
npm view @moneymux/sponsor-shell@0.1.2 version dist.integrity repository.url
npm exec --yes --package=@moneymux/sponsor-shell@0.1.2 -- sponsor-shell --version
SPONSOR_SHELL_API_BASE_URL=https://staging.moneymux.com \
  npm exec --yes --package=@moneymux/sponsor-shell@0.1.2 -- sponsor-shell doctor
```
